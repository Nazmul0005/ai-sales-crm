# AI Sales CRM - Video Demonstration Script

This document provides a step-by-step guide and script for recording a video demonstration of the AI Sales CRM project.

**Goal:** Demonstrate how the system uses AI to automate lead scoring, enrichment, and personalized email outreach.
...
**Action:**
- Turn camera on yourself OR show the Title Slide / Repository GitHub page.

**Script:**
> "Hello! Today I'm going to demonstrate an **AI-Powered Sales Campaign CRM**.
>
> In traditional sales, representatives spend hours manually researching leads, guessing their interest level, and writing generic emails that get ignored.
>
...
> 2.  **Email Service**: We use **MailHog** to intercept and display emails locally, so we don't spam real people during testing.
> 3.  **LLM Integration**: We're using **Groq**, which gives us incredibly fast inference speeds for real-time processing."
